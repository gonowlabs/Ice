...
describe UserSessionsController do
  ...
  context "respondendo para POST create apos logar o usuario" do
    before :each do
    ...
    it "deve enviar ele para a ultima pagina se existir ou a home" do
  ...
  context "respondendo para DELETE destroy" do
    ...
    it "deve destruir a sessao atual" do
      @user_session.should_receive(:destroy)
      delete :destroy
    end

    it "deve enviar o usuario para a ultima pagina se existir ou a raiz" do
      controller.should_receive(:redirect_back_or_default).with(root_path)
      delete :destroy
    end
